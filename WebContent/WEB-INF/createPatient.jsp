...
<!DOCTYPE html>
<html>
<c:set var="title" value="Create patient" />
...
<div class="table-center-buttons">
	...
	<form method="post">
		...
		<input required name="password" /><br> <label>name</label><br> <input required
			name="name" /><br> <label>surname</label><br> <input required
		...
		<label>Patient: date Birthday
		</label><br> <input name="additionalInfo" /><br> <input
